...
const features = [
  {
    ...
    description: 'Military-grade encryption and security protocols protect your assets.',
    gradient: 'from-[rgb(var(--nova-accent))] to-blue-400'
  },
  {
    icon: Zap,
    title: 'Lightning Fast',
    description: 'Instant transactions across multiple blockchains with minimal fees.',
    gradient: 'from-[rgb(var(--nova-purple))] to-pink-400'
  },
  {
    icon: Globe,
    title: 'Multi-Chain Support',
    description: 'Manage Ethereum, Solana, Bitcoin, and more from one interface.',
    gradient: 'from-[rgb(var(--nova-accent))] to-[rgb(var(--nova-purple))]'
  },
  {
    icon: Lock,
    title: 'Your Keys, Your Crypto',
    description: 'Non-custodial wallet gives you complete control over your assets.',
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            >
              ...
              >
                ...
                <span className="text-[rgb(var(--nova-accent))] font-medium">The Future is Here</span>
                <Star size={20} className="text-[rgb(var(--nova-accent))]" />
              </motion.div>
              ...
              >
                Experience the next generation of decentralized finance with NovaWallet. 
                Secure, fast, and designed for the multi-chain future.
              </motion.p>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <stat.icon size={32} className="text-[rgb(var(--nova-accent))] mb-4 mx-auto" />
                  <div className="text-4xl font-bold nova-gradient-text mb-3">{stat.value}</div>
                  <div className="text-[rgb(var(--nova-text-dim))]">{stat.label}</div>
                </motion.div>
              ))}
            </motion.div>
          </div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              <h2 className="text-5xl lg:text-6xl font-bold mb-8">
                Built for the <span className="nova-gradient-text">Decentralized Future</span>
              </h2>
              <p className="text-xl text-[rgb(var(--nova-text-dim))] max-w-4xl mx-auto leading-relaxed">
                NovaWallet combines cutting-edge security with intuitive design, 
                giving you the power to manage your digital assets like never before.
              </p>
            </motion.div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.gradient} p-4 mb-6 group-hover:scale-110 transition-transform duration-300 relative z-10`}>
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-4xl lg:text-5xl font-bold mb-8">
                  Ready to Enter the <span className="nova-gradient-text">Nova</span>?
                </h2>
                <p className="text-lg text-[rgb(var(--nova-text-dim))] mb-12 max-w-3xl mx-auto leading-relaxed">
                  Join thousands of users who have already discovered the future of crypto wallets.
