      ...
      <div className="min-h-screen bg-[rgb(var(--nova-bg))]">
        ...
        <main className="flex items-center justify-center min-h-screen p-6">
          <div className="text-center max-w-md">
            ...
            >
              <Wallet size={80} className="mx-auto mb-8 text-[rgb(var(--nova-accent))]" />
        ...
        >
          <div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">
              Welcome Back, <span className="nova-gradient-text">Crypto Pioneer</span>
            </h1>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              <div>
                <p className="text-[rgb(var(--nova-text-dim))] mb-3 text-lg">Total Portfolio Value</p>
              ...
              {recentTransactions.map((tx, index) => (
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-semibold text-lg capitalize">{tx.type} {tx.token}</div>
                      <div className="text-sm text-[rgb(var(--nova-text-dim))]">
